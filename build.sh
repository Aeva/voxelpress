...
echo ""
echo "------ libvoxelpress ------"
valac --pkg gee-1.0 --pkg gio-2.0 --library=libvoxelpress -H libvoxelpress.h ../libvoxelpress/VectorModel.vala ../libvoxelpress/plugin-api.vala -X -fPIC -X -shared -o libvoxelpress.so

# compile voxelcore
echo ""
echo "------ voxelcore ------"
valac --pkg gee-1.0 --pkg gio-2.0 --pkg gmodule-2.0 libvoxelpress.vapi ../voxelcore/debug.vala ../voxelcore/plugin-repository.vala ../voxelcore/import_stage.vala ../voxelcore/voxelcore.vala -X libvoxelpress.so -X -I. -o voxelpress
